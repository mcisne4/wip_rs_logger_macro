...
pub const MOD_IDX_EQ: &str = "#[mod_idx = 249]\n";
pub const MOD_IDX_TPL: &str = "#[mod_idx(249)]\n";

pub const LOCATION_EQ: &str = "#[location = \"rs_logs::example::path\"]\n";
pub const LOCATION_TPL: &str = "#[location(\"rs_logs::example::path\")]\n";
